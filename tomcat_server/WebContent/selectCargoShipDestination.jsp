...
<title>YDC check register planet page</title>
</head>
...
<body>
	...
	<div>
		<%
			manageCargoShip cargoShipManager = new manageCargoShip();
			cargoShipManager.updateCargoshipDestination(request, response);		
		%>
	</div>
